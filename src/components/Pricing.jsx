    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-white" id="prijzen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {/* Basis */}
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 hover:border-[#b03500]/30 hover:shadow-xl hover:scale-105 transition-all flex flex-col shadow-sm">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 hover:border-[#b03500]/30 hover:shadow-xl hover:scale-105 transition-all flex flex-col shadow-sm">
            ...
            <button className="w-full py-3 rounded-xl border-2 border-[#b03500] text-[#b03500] font-bold hover:bg-[#b03500] hover:text-white transition-all text-sm sm:text-base">Kies Normaal</button>
          </div>
          {/* Premium */}
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 hover:border-[#b03500]/30 hover:shadow-xl hover:scale-105 transition-all flex flex-col shadow-sm">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 hover:border-[#b03500]/30 hover:shadow-xl hover:scale-105 transition-all flex flex-col shadow-sm">
            ...
            <div className="text-3xl sm:text-4xl font-extrabold text-[#b03500] mb-6">€3.000</div>
            <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-grow">
              <li className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                <span className="material-symbols-outlined text-[#b03500] text-[16px] sm:text-[18px]" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span> 50 Rijlessen
              </li>
              <li className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                <span className="material-symbols-outlined text-[#b03500] text-[16px] sm:text-[18px]" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span> VIP begeleiding
              </li>
              <li className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                <span className="material-symbols-outlined text-[#b03500] text-[16px] sm:text-[18px]" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span> Onbeperkt theorie
              </li>
            </ul>
            <button className="w-full py-3 rounded-xl border-2 border-[#b03500] text-[#b03500] font-bold hover:bg-[#b03500] hover:text-white transition-all text-sm sm:text-base">Kies Deluxe</button>
          </div>
        </div>
      </div>
    </section>
